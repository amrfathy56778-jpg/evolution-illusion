...
7) استخدم Markdown. **أجب بنفس لغة المستخدم** — إذا كتب رسالته بالإنجليزية أجب بالإنجليزية، بالفرنسية فبالفرنسية، وهكذا. الافتراضي العربية الفصحى إذا كانت رسالة المستخدم بالعربية.
