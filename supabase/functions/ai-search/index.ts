...
3. اكتب إجابة موجزة تلخّص ما يجده المستخدم في تلك المنشورات. **استخدم نفس لغة سؤال المستخدم** (إذا سأل بالإنجليزية أجب بالإنجليزية، بالفرنسية أجب بالفرنسية، وهكذا).
